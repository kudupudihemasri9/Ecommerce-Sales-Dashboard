...
The dataset contains transaction-level e-commerce sales data, including:
...
| Customer Rating | Product/Service rating |
...
- Monitor overall business performance in a single dashboard.
